...
How can the built-in `fs` module accomplish appending data to a JSON file? (You may want to take 5 minutes to research how to accomplish the task of adding data to a json file. `fs.appendFile()` will not be able to keep the json formatted correctly.)
