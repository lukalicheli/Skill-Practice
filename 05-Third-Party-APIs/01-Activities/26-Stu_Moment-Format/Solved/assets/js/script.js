...
var gradDate = moment("2022-03-16").format("MMM Do, YYYY");
$("#1a").text(gradDate);

// TODO: 2. What day of the week will 1/1/2023 be?
var weekDay = moment("1-1-2023", "M-D-YYYY").format("ddd MMM Do, YYYY");
$("#2a").text(weekDay);
