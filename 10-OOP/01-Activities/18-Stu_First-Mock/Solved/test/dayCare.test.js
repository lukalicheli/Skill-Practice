...
describe("DayCare", () => {
  ...
  describe("addChild", () => {
    ...
    it("should not add a child if already at capacity", () => {
      ...
      // Provide alternate function to use for console.log during the test
      mock.mockImplementation(() => { });
      dayCare.children = [
        new Child("Tammy", 1),
        new Child("Mark", 2),
      ...
      // Restores console.log to its normal self so that code outside of the
      // test using console.log will work normally. 
      mock.mockRestore();
    });
