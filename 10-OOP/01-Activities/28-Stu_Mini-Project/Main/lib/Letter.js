...
class Letter {
  ...
  // Returns either an underscore or the underlying character depending on
  // `this.visible` because we call this function toString, when we call
  // `this.letters.join` in Word.js, JavaScript automatically uses the value
  // we return here
  toString() {
