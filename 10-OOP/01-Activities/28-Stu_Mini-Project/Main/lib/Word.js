...
// The Word class is responsible for creating an array of Letter objects and
...
class Word {
  ...
  guessedCorrectly() {
    // The `every` method returns true if the callback function returns true for
    // every element in the array
    return this.letters.every((letter) => letter.visible);
  }

  // setting `toString()` as a method lets us concatenate it like we would a
  // string!
  toString() {
