...
const ThoughtForm = () => {
  ...
  const [addThought, { error, loading }] = useMutation(ADD_THOUGHT, {
    ...
    update(cache, { data }) {
      try {
        ...
        cache.writeQuery({
          ...
          data: { thoughts: [data.addThought, ...thoughts] },
        });
      } catch (e) {
        console.error(e);
      }
    ...
    <div>
      ...
      >
        ...
        <div className="col-12 col-lg-3">
          <button disabled={loading} className="btn btn-primary btn-block py-3" type="submit">
