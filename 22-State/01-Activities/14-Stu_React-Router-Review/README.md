...
* It's done when I have created a route to render the `<SingleThought />` component.

* It's done when each thought includes a link to navigate to the single thought page.
