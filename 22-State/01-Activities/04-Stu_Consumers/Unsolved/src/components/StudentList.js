...
export default function StudentList() {
  ...
  const {students} = {}; // <-- Replace this line with your code
          ...
          <section className="student-list">
            ...
            <div className="add-student">
              ...
              <button
                type="button"
                onClick={() => {
                  // TODO: Write an onClick for the button so that it will add students. (Use the genid function to get an id for the student.)
                  // Your code here
                }}
              >
                Add Student
