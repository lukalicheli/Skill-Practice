/*
 * ADD_STUDENT:
 * - takes a student object as payload with id, name, and major parameters
...
/**
 * SET_STUDENT_NAME:
 * - takes a string in the payload
 * - payload will be used to update the value of state.studentName
 */
 ...
 * SET_STUDENT_MAJOR
 * - takes a string in the payload
 * - payload used to update the value of state.studentMajor 
 */
