...
// Create a new variable which holds the returned object from the `bankAccount` function.
const myBank = createBankAccount();

// With our newly created "bank" object call its `displayFunds` method.
myBank.displayFunds();
