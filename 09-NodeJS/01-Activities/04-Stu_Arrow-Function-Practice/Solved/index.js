...
var netflixQueue = {
  ...
  // Replace watchMovie arrow function with an anonymous function to give this
  // the correct context. (The netlixQueue object.)
  watchMovie: function() {
    this.queue.pop();
  },
  // Replace arrow function with function expression so that this will refer to the netflixQueue object.
