...
4. Add your password for the MySQL connection.

5. Run `node server.js` to start the Express.js server. The results of the query and the table are shown in the console.
