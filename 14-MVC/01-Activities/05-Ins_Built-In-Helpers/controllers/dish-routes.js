...
router.get('/', async (req, res) => {
  // The 2nd argument must always be an object! You cannot pass an array directly. However, you can include an array as a property of the object as is done with the dishes array in this example.
